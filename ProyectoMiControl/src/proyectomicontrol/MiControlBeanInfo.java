...
public class MiControlBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( proyectomicontrol.MiControl.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleHelp] = new PropertyDescriptor ( "accessibleHelp", proyectomicontrol.MiControl.class, "getAccessibleHelp", "setAccessibleHelp" ); // NOI18N
            properties[PROPERTY_accessibleRole] = new PropertyDescriptor ( "accessibleRole", proyectomicontrol.MiControl.class, "getAccessibleRole", "setAccessibleRole" ); // NOI18N
            properties[PROPERTY_accessibleRoleDescription] = new PropertyDescriptor ( "accessibleRoleDescription", proyectomicontrol.MiControl.class, "getAccessibleRoleDescription", "setAccessibleRoleDescription" ); // NOI18N
            properties[PROPERTY_accessibleText] = new PropertyDescriptor ( "accessibleText", proyectomicontrol.MiControl.class, "getAccessibleText", "setAccessibleText" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", proyectomicontrol.MiControl.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_baselineOffset] = new PropertyDescriptor ( "baselineOffset", proyectomicontrol.MiControl.class, "getBaselineOffset", null ); // NOI18N
            properties[PROPERTY_blendMode] = new PropertyDescriptor ( "blendMode", proyectomicontrol.MiControl.class, "getBlendMode", "setBlendMode" ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", proyectomicontrol.MiControl.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_boundsInLocal] = new PropertyDescriptor ( "boundsInLocal", proyectomicontrol.MiControl.class, "getBoundsInLocal", null ); // NOI18N
            properties[PROPERTY_boundsInParent] = new PropertyDescriptor ( "boundsInParent", proyectomicontrol.MiControl.class, "getBoundsInParent", null ); // NOI18N
            properties[PROPERTY_cache] = new PropertyDescriptor ( "cache", proyectomicontrol.MiControl.class, "isCache", "setCache" ); // NOI18N
            properties[PROPERTY_cacheHint] = new PropertyDescriptor ( "cacheHint", proyectomicontrol.MiControl.class, "getCacheHint", "setCacheHint" ); // NOI18N
            properties[PROPERTY_cacheShape] = new PropertyDescriptor ( "cacheShape", proyectomicontrol.MiControl.class, "isCacheShape", "setCacheShape" ); // NOI18N
            properties[PROPERTY_centerShape] = new PropertyDescriptor ( "centerShape", proyectomicontrol.MiControl.class, "isCenterShape", "setCenterShape" ); // NOI18N
            properties[PROPERTY_childrenUnmodifiable] = new PropertyDescriptor ( "childrenUnmodifiable", proyectomicontrol.MiControl.class, "getChildrenUnmodifiable", null ); // NOI18N
            properties[PROPERTY_clip] = new PropertyDescriptor ( "clip", proyectomicontrol.MiControl.class, "getClip", "setClip" ); // NOI18N
            properties[PROPERTY_contentBias] = new PropertyDescriptor ( "contentBias", proyectomicontrol.MiControl.class, "getContentBias", null ); // NOI18N
            properties[PROPERTY_cssMetaData] = new PropertyDescriptor ( "cssMetaData", proyectomicontrol.MiControl.class, "getCssMetaData", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", proyectomicontrol.MiControl.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_depthTest] = new PropertyDescriptor ( "depthTest", proyectomicontrol.MiControl.class, "getDepthTest", "setDepthTest" ); // NOI18N
            properties[PROPERTY_disable] = new PropertyDescriptor ( "disable", proyectomicontrol.MiControl.class, "isDisable", "setDisable" ); // NOI18N
            properties[PROPERTY_disabled] = new PropertyDescriptor ( "disabled", proyectomicontrol.MiControl.class, "isDisabled", null ); // NOI18N
            properties[PROPERTY_effect] = new PropertyDescriptor ( "effect", proyectomicontrol.MiControl.class, "getEffect", "setEffect" ); // NOI18N
            properties[PROPERTY_effectiveNodeOrientation] = new PropertyDescriptor ( "effectiveNodeOrientation", proyectomicontrol.MiControl.class, "getEffectiveNodeOrientation", null ); // NOI18N
            properties[PROPERTY_eventDispatcher] = new PropertyDescriptor ( "eventDispatcher", proyectomicontrol.MiControl.class, "getEventDispatcher", "setEventDispatcher" ); // NOI18N
            properties[PROPERTY_focused] = new PropertyDescriptor ( "focused", proyectomicontrol.MiControl.class, "isFocused", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", proyectomicontrol.MiControl.class, "isFocusTraversable", "setFocusTraversable" ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", proyectomicontrol.MiControl.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hover] = new PropertyDescriptor ( "hover", proyectomicontrol.MiControl.class, "isHover", null ); // NOI18N
            properties[PROPERTY_id] = new PropertyDescriptor ( "id", proyectomicontrol.MiControl.class, "getId", "setId" ); // NOI18N
            properties[PROPERTY_impl_traversalEngine] = new PropertyDescriptor ( "impl_traversalEngine", proyectomicontrol.MiControl.class, "getImpl_traversalEngine", "setImpl_traversalEngine" ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", proyectomicontrol.MiControl.class, "getInputMethodRequests", "setInputMethodRequests" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", proyectomicontrol.MiControl.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_layoutBounds] = new PropertyDescriptor ( "layoutBounds", proyectomicontrol.MiControl.class, "getLayoutBounds", null ); // NOI18N
            properties[PROPERTY_layoutX] = new PropertyDescriptor ( "layoutX", proyectomicontrol.MiControl.class, "getLayoutX", "setLayoutX" ); // NOI18N
            properties[PROPERTY_layoutY] = new PropertyDescriptor ( "layoutY", proyectomicontrol.MiControl.class, "getLayoutY", "setLayoutY" ); // NOI18N
            properties[PROPERTY_localToParentTransform] = new PropertyDescriptor ( "localToParentTransform", proyectomicontrol.MiControl.class, "getLocalToParentTransform", null ); // NOI18N
            properties[PROPERTY_localToSceneTransform] = new PropertyDescriptor ( "localToSceneTransform", proyectomicontrol.MiControl.class, "getLocalToSceneTransform", null ); // NOI18N
            properties[PROPERTY_managed] = new PropertyDescriptor ( "managed", proyectomicontrol.MiControl.class, "isManaged", "setManaged" ); // NOI18N
            properties[PROPERTY_maxHeight] = new PropertyDescriptor ( "maxHeight", proyectomicontrol.MiControl.class, "getMaxHeight", "setMaxHeight" ); // NOI18N
            properties[PROPERTY_maxWidth] = new PropertyDescriptor ( "maxWidth", proyectomicontrol.MiControl.class, "getMaxWidth", "setMaxWidth" ); // NOI18N
            properties[PROPERTY_minHeight] = new PropertyDescriptor ( "minHeight", proyectomicontrol.MiControl.class, "getMinHeight", "setMinHeight" ); // NOI18N
            properties[PROPERTY_minWidth] = new PropertyDescriptor ( "minWidth", proyectomicontrol.MiControl.class, "getMinWidth", "setMinWidth" ); // NOI18N
            properties[PROPERTY_mouseTransparent] = new PropertyDescriptor ( "mouseTransparent", proyectomicontrol.MiControl.class, "isMouseTransparent", "setMouseTransparent" ); // NOI18N
            properties[PROPERTY_needsLayout] = new PropertyDescriptor ( "needsLayout", proyectomicontrol.MiControl.class, "isNeedsLayout", null ); // NOI18N
            properties[PROPERTY_nodeOrientation] = new PropertyDescriptor ( "nodeOrientation", proyectomicontrol.MiControl.class, "getNodeOrientation", "setNodeOrientation" ); // NOI18N
            properties[PROPERTY_onAction] = new PropertyDescriptor ( "onAction", proyectomicontrol.MiControl.class, "getOnAction", "setOnAction" ); // NOI18N
            properties[PROPERTY_onContextMenuRequested] = new PropertyDescriptor ( "onContextMenuRequested", proyectomicontrol.MiControl.class, "getOnContextMenuRequested", "setOnContextMenuRequested" ); // NOI18N
            properties[PROPERTY_onDragDetected] = new PropertyDescriptor ( "onDragDetected", proyectomicontrol.MiControl.class, "getOnDragDetected", "setOnDragDetected" ); // NOI18N
            properties[PROPERTY_onDragDone] = new PropertyDescriptor ( "onDragDone", proyectomicontrol.MiControl.class, "getOnDragDone", "setOnDragDone" ); // NOI18N
            properties[PROPERTY_onDragDropped] = new PropertyDescriptor ( "onDragDropped", proyectomicontrol.MiControl.class, "getOnDragDropped", "setOnDragDropped" ); // NOI18N
            properties[PROPERTY_onDragEntered] = new PropertyDescriptor ( "onDragEntered", proyectomicontrol.MiControl.class, "getOnDragEntered", "setOnDragEntered" ); // NOI18N
            properties[PROPERTY_onDragExited] = new PropertyDescriptor ( "onDragExited", proyectomicontrol.MiControl.class, "getOnDragExited", "setOnDragExited" ); // NOI18N
            properties[PROPERTY_onDragOver] = new PropertyDescriptor ( "onDragOver", proyectomicontrol.MiControl.class, "getOnDragOver", "setOnDragOver" ); // NOI18N
            properties[PROPERTY_onInputMethodTextChanged] = new PropertyDescriptor ( "onInputMethodTextChanged", proyectomicontrol.MiControl.class, "getOnInputMethodTextChanged", "setOnInputMethodTextChanged" ); // NOI18N
            properties[PROPERTY_onKeyPressed] = new PropertyDescriptor ( "onKeyPressed", proyectomicontrol.MiControl.class, "getOnKeyPressed", "setOnKeyPressed" ); // NOI18N
            properties[PROPERTY_onKeyReleased] = new PropertyDescriptor ( "onKeyReleased", proyectomicontrol.MiControl.class, "getOnKeyReleased", "setOnKeyReleased" ); // NOI18N
            properties[PROPERTY_onKeyTyped] = new PropertyDescriptor ( "onKeyTyped", proyectomicontrol.MiControl.class, "getOnKeyTyped", "setOnKeyTyped" ); // NOI18N
            properties[PROPERTY_onMouseClicked] = new PropertyDescriptor ( "onMouseClicked", proyectomicontrol.MiControl.class, "getOnMouseClicked", "setOnMouseClicked" ); // NOI18N
            properties[PROPERTY_onMouseDragEntered] = new PropertyDescriptor ( "onMouseDragEntered", proyectomicontrol.MiControl.class, "getOnMouseDragEntered", "setOnMouseDragEntered" ); // NOI18N
            properties[PROPERTY_onMouseDragExited] = new PropertyDescriptor ( "onMouseDragExited", proyectomicontrol.MiControl.class, "getOnMouseDragExited", "setOnMouseDragExited" ); // NOI18N
            properties[PROPERTY_onMouseDragged] = new PropertyDescriptor ( "onMouseDragged", proyectomicontrol.MiControl.class, "getOnMouseDragged", "setOnMouseDragged" ); // NOI18N
            properties[PROPERTY_onMouseDragOver] = new PropertyDescriptor ( "onMouseDragOver", proyectomicontrol.MiControl.class, "getOnMouseDragOver", "setOnMouseDragOver" ); // NOI18N
            properties[PROPERTY_onMouseDragReleased] = new PropertyDescriptor ( "onMouseDragReleased", proyectomicontrol.MiControl.class, "getOnMouseDragReleased", "setOnMouseDragReleased" ); // NOI18N
            properties[PROPERTY_onMouseEntered] = new PropertyDescriptor ( "onMouseEntered", proyectomicontrol.MiControl.class, "getOnMouseEntered", "setOnMouseEntered" ); // NOI18N
            properties[PROPERTY_onMouseExited] = new PropertyDescriptor ( "onMouseExited", proyectomicontrol.MiControl.class, "getOnMouseExited", "setOnMouseExited" ); // NOI18N
            properties[PROPERTY_onMouseMoved] = new PropertyDescriptor ( "onMouseMoved", proyectomicontrol.MiControl.class, "getOnMouseMoved", "setOnMouseMoved" ); // NOI18N
            properties[PROPERTY_onMousePressed] = new PropertyDescriptor ( "onMousePressed", proyectomicontrol.MiControl.class, "getOnMousePressed", "setOnMousePressed" ); // NOI18N
            properties[PROPERTY_onMouseReleased] = new PropertyDescriptor ( "onMouseReleased", proyectomicontrol.MiControl.class, "getOnMouseReleased", "setOnMouseReleased" ); // NOI18N
            properties[PROPERTY_onRotate] = new PropertyDescriptor ( "onRotate", proyectomicontrol.MiControl.class, "getOnRotate", "setOnRotate" ); // NOI18N
            properties[PROPERTY_onRotationFinished] = new PropertyDescriptor ( "onRotationFinished", proyectomicontrol.MiControl.class, "getOnRotationFinished", "setOnRotationFinished" ); // NOI18N
            properties[PROPERTY_onRotationStarted] = new PropertyDescriptor ( "onRotationStarted", proyectomicontrol.MiControl.class, "getOnRotationStarted", "setOnRotationStarted" ); // NOI18N
            properties[PROPERTY_onScroll] = new PropertyDescriptor ( "onScroll", proyectomicontrol.MiControl.class, "getOnScroll", "setOnScroll" ); // NOI18N
            properties[PROPERTY_onScrollFinished] = new PropertyDescriptor ( "onScrollFinished", proyectomicontrol.MiControl.class, "getOnScrollFinished", "setOnScrollFinished" ); // NOI18N
            properties[PROPERTY_onScrollStarted] = new PropertyDescriptor ( "onScrollStarted", proyectomicontrol.MiControl.class, "getOnScrollStarted", "setOnScrollStarted" ); // NOI18N
            properties[PROPERTY_onSwipeDown] = new PropertyDescriptor ( "onSwipeDown", proyectomicontrol.MiControl.class, "getOnSwipeDown", "setOnSwipeDown" ); // NOI18N
            properties[PROPERTY_onSwipeLeft] = new PropertyDescriptor ( "onSwipeLeft", proyectomicontrol.MiControl.class, "getOnSwipeLeft", "setOnSwipeLeft" ); // NOI18N
            properties[PROPERTY_onSwipeRight] = new PropertyDescriptor ( "onSwipeRight", proyectomicontrol.MiControl.class, "getOnSwipeRight", "setOnSwipeRight" ); // NOI18N
            properties[PROPERTY_onSwipeUp] = new PropertyDescriptor ( "onSwipeUp", proyectomicontrol.MiControl.class, "getOnSwipeUp", "setOnSwipeUp" ); // NOI18N
            properties[PROPERTY_onTouchMoved] = new PropertyDescriptor ( "onTouchMoved", proyectomicontrol.MiControl.class, "getOnTouchMoved", "setOnTouchMoved" ); // NOI18N
            properties[PROPERTY_onTouchPressed] = new PropertyDescriptor ( "onTouchPressed", proyectomicontrol.MiControl.class, "getOnTouchPressed", "setOnTouchPressed" ); // NOI18N
            properties[PROPERTY_onTouchReleased] = new PropertyDescriptor ( "onTouchReleased", proyectomicontrol.MiControl.class, "getOnTouchReleased", "setOnTouchReleased" ); // NOI18N
            properties[PROPERTY_onTouchStationary] = new PropertyDescriptor ( "onTouchStationary", proyectomicontrol.MiControl.class, "getOnTouchStationary", "setOnTouchStationary" ); // NOI18N
            properties[PROPERTY_onZoom] = new PropertyDescriptor ( "onZoom", proyectomicontrol.MiControl.class, "getOnZoom", "setOnZoom" ); // NOI18N
            properties[PROPERTY_onZoomFinished] = new PropertyDescriptor ( "onZoomFinished", proyectomicontrol.MiControl.class, "getOnZoomFinished", "setOnZoomFinished" ); // NOI18N
            properties[PROPERTY_onZoomStarted] = new PropertyDescriptor ( "onZoomStarted", proyectomicontrol.MiControl.class, "getOnZoomStarted", "setOnZoomStarted" ); // NOI18N
            properties[PROPERTY_opacity] = new PropertyDescriptor ( "opacity", proyectomicontrol.MiControl.class, "getOpacity", "setOpacity" ); // NOI18N
            properties[PROPERTY_opaqueInsets] = new PropertyDescriptor ( "opaqueInsets", proyectomicontrol.MiControl.class, "getOpaqueInsets", "setOpaqueInsets" ); // NOI18N
            properties[PROPERTY_padding] = new PropertyDescriptor ( "padding", proyectomicontrol.MiControl.class, "getPadding", "setPadding" ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", proyectomicontrol.MiControl.class, "getParent", null ); // NOI18N
            properties[PROPERTY_pickOnBounds] = new PropertyDescriptor ( "pickOnBounds", proyectomicontrol.MiControl.class, "isPickOnBounds", "setPickOnBounds" ); // NOI18N
            properties[PROPERTY_prefHeight] = new PropertyDescriptor ( "prefHeight", proyectomicontrol.MiControl.class, "getPrefHeight", "setPrefHeight" ); // NOI18N
            properties[PROPERTY_prefWidth] = new PropertyDescriptor ( "prefWidth", proyectomicontrol.MiControl.class, "getPrefWidth", "setPrefWidth" ); // NOI18N
            properties[PROPERTY_pressed] = new PropertyDescriptor ( "pressed", proyectomicontrol.MiControl.class, "isPressed", null ); // NOI18N
            properties[PROPERTY_properties] = new PropertyDescriptor ( "properties", proyectomicontrol.MiControl.class, "getProperties", null ); // NOI18N
            properties[PROPERTY_pseudoClassStates] = new PropertyDescriptor ( "pseudoClassStates", proyectomicontrol.MiControl.class, "getPseudoClassStates", null ); // NOI18N
            properties[PROPERTY_resizable] = new PropertyDescriptor ( "resizable", proyectomicontrol.MiControl.class, "isResizable", null ); // NOI18N
            properties[PROPERTY_rotate] = new PropertyDescriptor ( "rotate", proyectomicontrol.MiControl.class, "getRotate", "setRotate" ); // NOI18N
            properties[PROPERTY_rotationAxis] = new PropertyDescriptor ( "rotationAxis", proyectomicontrol.MiControl.class, "getRotationAxis", "setRotationAxis" ); // NOI18N
            properties[PROPERTY_scaleShape] = new PropertyDescriptor ( "scaleShape", proyectomicontrol.MiControl.class, "isScaleShape", "setScaleShape" ); // NOI18N
            properties[PROPERTY_scaleX] = new PropertyDescriptor ( "scaleX", proyectomicontrol.MiControl.class, "getScaleX", "setScaleX" ); // NOI18N
            properties[PROPERTY_scaleY] = new PropertyDescriptor ( "scaleY", proyectomicontrol.MiControl.class, "getScaleY", "setScaleY" ); // NOI18N
            properties[PROPERTY_scaleZ] = new PropertyDescriptor ( "scaleZ", proyectomicontrol.MiControl.class, "getScaleZ", "setScaleZ" ); // NOI18N
            properties[PROPERTY_scene] = new PropertyDescriptor ( "scene", proyectomicontrol.MiControl.class, "getScene", null ); // NOI18N
            properties[PROPERTY_shape] = new PropertyDescriptor ( "shape", proyectomicontrol.MiControl.class, "getShape", "setShape" ); // NOI18N
            properties[PROPERTY_snapToPixel] = new PropertyDescriptor ( "snapToPixel", proyectomicontrol.MiControl.class, "isSnapToPixel", "setSnapToPixel" ); // NOI18N
            properties[PROPERTY_style] = new PropertyDescriptor ( "style", proyectomicontrol.MiControl.class, "getStyle", "setStyle" ); // NOI18N
            properties[PROPERTY_styleableParent] = new PropertyDescriptor ( "styleableParent", proyectomicontrol.MiControl.class, "getStyleableParent", null ); // NOI18N
            properties[PROPERTY_styleClass] = new PropertyDescriptor ( "styleClass", proyectomicontrol.MiControl.class, "getStyleClass", null ); // NOI18N
            properties[PROPERTY_stylesheets] = new PropertyDescriptor ( "stylesheets", proyectomicontrol.MiControl.class, "getStylesheets", null ); // NOI18N
            properties[PROPERTY_transforms] = new PropertyDescriptor ( "transforms", proyectomicontrol.MiControl.class, "getTransforms", null ); // NOI18N
            properties[PROPERTY_translateX] = new PropertyDescriptor ( "translateX", proyectomicontrol.MiControl.class, "getTranslateX", "setTranslateX" ); // NOI18N
            properties[PROPERTY_translateY] = new PropertyDescriptor ( "translateY", proyectomicontrol.MiControl.class, "getTranslateY", "setTranslateY" ); // NOI18N
            properties[PROPERTY_translateZ] = new PropertyDescriptor ( "translateZ", proyectomicontrol.MiControl.class, "getTranslateZ", "setTranslateZ" ); // NOI18N
            properties[PROPERTY_typeSelector] = new PropertyDescriptor ( "typeSelector", proyectomicontrol.MiControl.class, "getTypeSelector", null ); // NOI18N
            properties[PROPERTY_userAgentStylesheet] = new PropertyDescriptor ( "userAgentStylesheet", proyectomicontrol.MiControl.class, "getUserAgentStylesheet", null ); // NOI18N
            properties[PROPERTY_userData] = new PropertyDescriptor ( "userData", proyectomicontrol.MiControl.class, "getUserData", "setUserData" ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", proyectomicontrol.MiControl.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", proyectomicontrol.MiControl.class, "getWidth", null ); // NOI18N
        }
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_onActionProperty111] = new MethodDescriptor(proyectomicontrol.MiControl.class.getMethod("onActionProperty", new Class[] {})); // NOI18N
